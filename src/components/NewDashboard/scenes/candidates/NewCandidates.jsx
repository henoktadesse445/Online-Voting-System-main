    ...
    const columns = [
        {
            ...
            renderCell: ({ row: { img } }) => {
                return (
                    ...
                    >
                    {img ? <img src={`${BASE_URL}${img}`} alt="Candidate" /> : <span>No image</span>}
                    </Box>
                );
            },
        },
        ...
        },
        {
            ...
            renderCell: ({ row }) => {
                return (
                    <Box>
                        <span id='delete' className='Button-span'><Button variant="contained" sx={{ backgroundColor: colors.redAccent[600], color: 'white', marginRight: 2 }} onClick={()=>deleteCandidate(row._id)}>Delete</Button></span>
                    </Box>
                );
            },
        },
